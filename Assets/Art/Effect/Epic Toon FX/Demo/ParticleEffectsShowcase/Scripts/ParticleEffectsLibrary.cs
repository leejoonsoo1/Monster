...
//	public string[] ParticleEffectDisplayNames;
	...
	public void SpawnParticleEffect(Vector3 positionInWorldToSpawn) 
    {
		...
		GameObject newParticleEffect = GameObject.Instantiate(ParticleEffectPrefabs[CurrentParticleEffectIndex], 
            spawnPosition, 
            ParticleEffectPrefabs[CurrentParticleEffectIndex].transform.rotation) as GameObject;
